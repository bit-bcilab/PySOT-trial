...
from pysot.models.head.siamatt_head import ConvModule
...
class FusedSemanticHead(nn.Module):
    def __init__(self,
        ...
        #                                        no_trans=False,
        #                                        trans_std=0.1)
        self.roi_pool_m = DeformRoIPoolPack(spatial_scale=1 / (cfg.TRAIN.SEARCH_SIZE / 63),
                                            output_size=cfg.TRAIN.ROIPOOL_OUTSIZE,
                                            output_channels=256,
                                            gamma=0.1)
        '''
...
def get_refine_head(name, **kwargs):
