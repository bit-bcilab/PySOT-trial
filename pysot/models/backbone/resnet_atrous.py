...
class ResNet(nn.Module):
    def __init__(self, block, layers, used_layers, freeze_bn=False):
        self.inplanes = 64
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1):
        ...
        layers = []
        layers.append(block(self.inplanes, planes, stride, downsample, dilation=dilation, freeze_bn=self.freeze_bn))
        self.inplanes = planes * block.expansion
        for i in range(1, blocks):
            layers.append(block(self.inplanes, planes, dilation=dilation, freeze_bn=self.freeze_bn))
