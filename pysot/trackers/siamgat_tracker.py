...
from pysot.utils.bbox import bbox_clip


class SiamGATTracker(SiameseTracker):
    def __init__(self, cfg, model):
        super(SiamGATTracker, self).__init__(cfg, model)
    ...
    def init(self, img, bbox):
        ...
        scale = self.cfg.TRACK.EXEMPLAR_SIZE / s_z
        c = (self.cfg.TRACK.EXEMPLAR_SIZE - 1) / 2
    ...
    def track(self, img):
        ...
        scale_score = upsize / (self.cfg.TRACK.SCORE_SIZE - 1)
        ...
        lr = penalty * cls_up[CRowUp, CColUp] * self.cfg.TRACK.LR
