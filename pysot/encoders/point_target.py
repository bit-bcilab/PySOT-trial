...
def point_target(cfg, bbox, points, size, neg=False):
    ...
    delta[0] = points[0] - bbox[0]
    delta[1] = points[1] - bbox[1]
    delta[2] = bbox[2] - points[0]
    delta[3] = bbox[3] - points[1]
...
#     a = PointTarget()
#     box = np.array([100, 120, 156, 136], dtype=np.float32)
#     b = a(box, 25)
